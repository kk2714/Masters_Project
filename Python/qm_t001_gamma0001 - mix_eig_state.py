...
wave_func = 1/np.sqrt(4) * eigenstates[0] + 1/np.sqrt(4) * eigenstates[1] + 1/np.sqrt(4) * eigenstates[2] + 1/np.sqrt(4) * eigenstates[3] 
init_rho = project_A * (wave_func.T * wave_func)
init_rho = init_rho / trace_matrix(init_rho)

## Define name to save figures automatically
init_state_str = 'mix_eig_state_'
