...
### Coherent state for this case
p_init = np.sqrt(3 * kb * T * mass)/57.74
q_init = 0
wavefunc = init_coherent_state(dim, p_init, q_init, mass, omega, hbar)
init_rho = wavefunc * wavefunc.T
init_rho = init_rho / trace_matrix(init_rho)

## Define name to save figures automatically
init_state_str = 'coherent_state_middle_'
